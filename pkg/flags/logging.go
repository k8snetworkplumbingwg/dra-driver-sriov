...
func NewLoggingConfig() *LoggingConfig {
	return &LoggingConfig{config: logsapi.NewLoggingConfiguration()}
}
...
func (l *LoggingConfig) Apply(featureGate featuregate.FeatureGate) error {
	return logsapi.ValidateAndApply(l.config, featureGate)
}
